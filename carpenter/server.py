...
from carpenter.utils.generate_ts_types import generate_typescript_types
from carpenter.middleware.authorization import AuthorizationMiddleware
from carpenter.utils.page_mapper import map_page_routes
...
async def lifespan(app: Starlette):
    ...
    if frontend_port:
        logger.info(f"[CARPENTER] > Client port             : {frontend_port}")
    logger.info("--------------------------------------------------")
